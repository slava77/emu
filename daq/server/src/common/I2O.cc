...
//     LOG4CPLUS_DEBUG(logger_, "emu::daq::server::I2O::addData: " << dataBlocks_.size() << " data blocks pending.");

}

void emu::daq::server::I2O::appendNewBlock( char* const         data, 
...
void emu::daq::server::I2O::insertNumberOfCreditsHeld( toolbox::mem::Reference *bufRef, bool completesEvent ){
...
//     LOG4CPLUS_DEBUG(logger_, "emu::daq::server::I2O::sendData: " << dataBlocks_.size() << " data blocks pending.");
  }

}

void emu::daq::server::I2O::makeLastBlockCompleteEvent(){
