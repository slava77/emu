var TREE_ITEMS = [
	    ['DDU', ' ',
                    ['DDU: Connected and Active Inputs','DDU_Connected_and_Active_Inputs.png'],
                    ['DDU: DMBs DAV and Unpacked vs DMBs Active','DDU_DMBs_DAV_and_Unpacked_vs_DMBs_Active.png'],
                    ['DDU: Data Format Errors and Warnings in Tables','DDU_Data_Format_Errors_and_Warnings_in_Tables.png'],
                    ['DDU: Data Integrity Checks vs Event Number','DDU_Data_Integrity_Checks_vs_Event_Number.png'],
                    ['DDU: Error Status from DDU Trailer','DDU_Error_Status_from_DDU_Trailer.png'],
                    ['DDU: Error Status from DDU Trailer vs Event Number','DDU_Error_Status_from_DDU_Trailer_vs_Event_Number.png'],
                    ['DDU: Event Buffer Size and DDU Word Count','DDU_Event_Buffer_Size_and_DDU_Word_Count.png'],
                    ['DDU: L1A and BXN Counters','DDU_L1A_and_BXN_Counters.png'],
                    ['DDU: Source IDs','DDU_Source_IDs.png'],
                    ['DDU: State of CSCs','DDU_State_of_CSCs.png'],
                    ['DDU: Unpacked DMBs','DDU_Unpacked_DMBs.png']
            ],
            ['CSC', ' ',
                    ...
                    ['CFEB: Pedestals (First Sample)','CFEB/CFEB_Pedestals_(First_Sample).png'],
                    ...
                    ['DMB: FEB Status (Timeouts, FIFO, L1 pipe)','DMB/DMB_FEB_Status_(Timeouts__FIFO__L1_pipe).png'],
                    ...
                    ['SYNC: CFEB - DMB Phase Synchronization','SYNC/SYNC_CFEB_-_DMB_Phase_Synchronization.png'],
                    ...
                    ['TMB-CLCT: CLCT0 Key DiStrips, Patterns and Quality','TMB/TMB-CLCT_CLCT0_Key_DiStrips__Patterns_and_Quality.png'],
                    ...
                    ['TMB-CLCT: CLCT1 Key DiStrips, Patterns and Quality','TMB/TMB-CLCT_CLCT1_Key_DiStrips__Patterns_and_Quality.png'],
