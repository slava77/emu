...
/*
void EmuPlotter::SaveImagesFromROOTFile(std::string rootfile,std::string path, std::string format, int width, int height)
{
  if (rootfile == "") { return;}
...
void EmuPlotter::createTreePage(std::string path)
{
	std::ofstream fout;
...
void EmuPlotter::createTreeEngine(std::string path ) 
{
  std::ofstream fout;
...
void EmuPlotter::createTreeTemplate(std::string path)
{
  std::ofstream fout;
