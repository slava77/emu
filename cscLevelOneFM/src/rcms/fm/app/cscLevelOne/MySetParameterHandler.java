...
public class MySetParameterHandler extends UserEventHandler {
	...
	static RCMSLogger logger = new RCMSLogger(MySetParameterHandler.class);
	...
	private void processGuiCommands(ParameterSet parameters) {
		/*
                ...
                functionManager.getParameterSet().put( new FunctionManagerParameter<StringT>(MyParameters.GUI_COMMAND, new StringT("")) );
