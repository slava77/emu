...
emuFU::EmuEventHeaderTrailer::EmuEventHeaderTrailer( bool calibration, bool normalTrigger, bool TFPresent ){
...
void emuFU::EmuEventHeaderTrailer::setL1ACounter( unsigned int L1ACounter ){
...
void emuFU::EmuEventHeaderTrailer::setDDUCount( unsigned short DDUCount ){
  header_[1] &= 0xFF80; // zero DDU count part
  header_[1] |= 0x007F & DDUCount;
}

void emuFU::EmuEventHeaderTrailer::setCSCConfigId( unsigned int CSCConfigId ){
  trailer_[0] = (unsigned short) ( 0x0000FFFF &   CSCConfigId         );
  trailer_[1] = (unsigned short) ( 0x0000FFFF & ( CSCConfigId >> 16 ) );
}

void emuFU::EmuEventHeaderTrailer::setTFConfigId( unsigned int TFConfigId ){
