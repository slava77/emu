...
protected:
  ...
  short ring_loop;		///< the number of times the reading of the data ring buffer has looped back
  short ring_loop_kern;         ///< the number of times the writing of the data ring buffer has looped back as obtained from the current entry of the packet info ring
  short ring_loop_kern2;        ///< the number of times the writing of the data ring buffer has looped back as obtained from the first entry of the packet info ring
  short timeout;  ///< timeout waiting for event
  short packets; ///< number of packets in event
