#include"DDUFileReader.cc"
#include<iostream>
#include<iomanip>
#include<stdio.h>
#include<stdlib.h>
// To compile: g++ -W -Wall -o test DDUFileReader.cpp -I../../src/common -I../../include/
...
int main(int argc, char *argv[]	){
	...
	qwe.reject(DDUFileReader::DDUoversize|DDUFileReader::FFFF|DDUFileReader::Unknown);
