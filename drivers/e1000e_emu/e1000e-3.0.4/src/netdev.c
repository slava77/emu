...
#endif
{
	...
	printk(KERN_INFO "e1001e e1000_clean_rx_irq 1 netdev->name %s\n",netdev->name);
...
#endif
		printk(KERN_INFO "e1001e e1000_clean_rx_irq 2 netdev->name %s\n",netdev->name);
...
#endif
{
	...
	printk(KERN_INFO "e1001e e1000_clean_rx_irq_ps 1 netdev->name %s\n",netdev->name);
...
copydone:
		...
		printk(KERN_INFO "e1001e e1000_clean_rx_irq_ps 2 netdev->name %s\n",netdev->name);
				     ...
				     int work_to_do)
{
	...
	printk(KERN_INFO "e1001e e1000_clean_jumbo_rx_irq 1 netdev->name %s\n",netdev->name);
	...
	printk(KERN_INFO "e1001e e1000_clean_jumbo_rx_irq 1a staterr=0x%x E1000_RXD_STAT_DD=0x%x rx_ring->next_to_clean=%d(%d)\n",staterr,E1000_RXD_STAT_DD,rx_ring->next_to_clean,i);
...
#define rxtop (rx_ring->rx_skb_top)
		...
		printk(KERN_INFO "e1001e e1000_clean_jumbo_rx_irq 2 netdev->name %s\n",netdev->name);
...
static void e1000_setup_rctl(struct e1000_adapter *adapter)
{
	...
	printk(KERN_INFO 
	       "ETH4  adapter->netdev->mtu %d, pages %d, PAGE_SIZE %d, rctl 0x%x, E1000_RCTL_LPE 0x%x, (rctl & E1000_RCTL_LPE) 0x%x, adapter->rx_ps_pages %d\n"
	       ,      adapter->netdev->mtu,    pages,    PAGE_SIZE,    rctl,      E1000_RCTL_LPE,      (rctl & E1000_RCTL_LPE),      adapter->rx_ps_pages);
	// Force packet split pages to be zero to prevent packets from being split
	//adapter->rx_ps_pages = 0;
...
static void e1000_configure_rx(struct e1000_adapter *adapter)
{
	...
	printk(KERN_INFO 
	       "ETH4 e1000_configure_rx adapter->netdev->mtu %d, ETH_FRAME_LEN %d, ETH_FCS_LEN 0x%x, adapter->rx_ps_pages %d\n"
	                         ,      adapter->netdev->mtu,    ETH_FRAME_LEN,    ETH_FCS_LEN,      adapter->rx_ps_pages);
	...
	if (adapter->rx_ps_pages) {
		...
		printk(KERN_INFO "ETH4 e1000_configure_rx rdlen=%d", rdlen );
#endif
	} else {
		rdlen = rx_ring->count * sizeof(union e1000_rx_desc_extended);
...
static int e1000_change_mtu(struct net_device *netdev, int new_mtu)
{
	...
	printk(KERN_INFO "e1001e e1000_change_mtu new_mtu %d, ETH_ZLEN %d, ETH_FCS_LEN %d, VLAN_HLEN %d, max_frame %d, adapter->max_hw_frame_size %d\n",new_mtu, ETH_ZLEN, ETH_FCS_LEN, VLAN_HLEN, max_frame, adapter->max_hw_frame_size);
