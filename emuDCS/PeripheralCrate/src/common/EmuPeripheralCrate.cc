...
{	
  ...
  xgi::bind(this,&EmuPeripheralCrate::TMBConfigure, "TMBConfigure");
  ...
  //----------------------------------------------
  xgi::bind(this,&EmuPeripheralCrate::InitChamber, "InitChamber");                            //should be deprecated
  ...
  //
  xoap::bind(this,&EmuPeripheralCrate::EnableJtagWriteALCT384      ,"EnableALCT384",XDAQ_NS_URI);
  xoap::bind(this,&EmuPeripheralCrate::EnableJtagWriteALCT384Mirror,"EnableALCT384Mirror",XDAQ_NS_URI);
  xoap::bind(this,&EmuPeripheralCrate::EnableJtagWriteALCT576Mirror,"EnableALCT576Mirror",XDAQ_NS_URI);
  xoap::bind(this,&EmuPeripheralCrate::EnableJtagWriteALCT672      ,"EnableALCT672",XDAQ_NS_URI);
  //
  //-------------------------------------------------------------
  ...
  //
  fsm_.addStateTransition('H', 'C', "Configure", this, &EmuPeripheralCrate::configureAction);
  fsm_.addStateTransition('C', 'C', "Configure", this, &EmuPeripheralCrate::reConfigureAction);
  fsm_.addStateTransition('C', 'E', "Enable",    this, &EmuPeripheralCrate::enableAction);
  fsm_.addStateTransition('E', 'E', "Enable",    this, &EmuPeripheralCrate::enableAction);
  fsm_.addStateTransition('E', 'C', "Disable",   this, &EmuPeripheralCrate::disableAction);
  fsm_.addStateTransition('C', 'H', "Halt",      this, &EmuPeripheralCrate::haltAction);
  fsm_.addStateTransition('E', 'H', "Halt",      this, &EmuPeripheralCrate::haltAction);
  fsm_.addStateTransition('H', 'H', "Halt",      this, &EmuPeripheralCrate::haltAction);
  //
...
void EmuPeripheralCrate::MainPage(xgi::Input * in, xgi::Output * out ) {
  ...
  *out << cgicc::form() << std::endl ;
  //
  std::cout << "Number of TMBs = " << tmbVector.size() << std::endl;
  //
  if (tmbVector.size()>0 || dmbVector.size()>0) {
    //
    if ( Operator_.find("NameOld",0) == string::npos ) {
      ...
      *out << cgicc::a("[Crate Configuration]").set("href",CrateConfiguration) << endl;
      //
      std::string CrateXUtils = toolbox::toString("/%s/CrateXUtils",getApplicationDescriptor()->getURN().c_str());
...
//
void EmuPeripheralCrate::Default(xgi::Input * in, xgi::Output * out ) 
  throw (xgi::exception::Exception) {
...
//#ifndef STANDALONE
//
xoap::MessageReference EmuPeripheralCrate::onCalibration(xoap::MessageReference message) 
...
void EmuPeripheralCrate::DefineConfiguration(xgi::Input * in, xgi::Output * out ) 
  ...
  *out << std::endl;
  //
  std::string methodRaw = toolbox::toString("/%s/setRawConfFile",getApplicationDescriptor()->getURN().c_str());
  *out << cgicc::form().set("method","POST").set("action",methodRaw) << std::endl ;
  *out << cgicc::textarea().set("name","Text").set("WRAP","OFF").set("rows","10").set("cols","90");
  ...
  *out << std::endl;
  //    
  std::string getTestLogFile = toolbox::toString("/%s/getTestLogFile",getApplicationDescriptor()->getURN().c_str());
  *out << cgicc::form().set("method","POST").set("action",getTestLogFile) << std::endl ;
  *out << cgicc::input().set("type","text").set("name","TestLogFile").set("size","90").set("ENCTYPE","multipart/form-data").set("value",TestLogFile_);
  *out << cgicc::input().set("type","submit").set("value","Restore Test configuration") << std::endl ;
  *out << cgicc::form() << std::endl ;
  //
  std::string getTestLogFileUpload = toolbox::toString("/%s/getTestLogFileUpload",getApplicationDescriptor()->getURN().c_str());
  *out << cgicc::form().set("method","POST").set("enctype","multipart/form-data").set("action",getTestLogFileUpload) << std::endl ;
  *out << cgicc::input().set("type","file").set("name","TestFileUpload").set("size","90") << std::endl;
...
void EmuPeripheralCrate::CrateXUtils(xgi::Input * in, xgi::Output * out ) 
  ...
  *out << cgicc::input().set("type","submit").set("value","Dump Crate Configuration").set("name","CrateDumpConfiguration") << std::endl ;
  *out << cgicc::form() << std::endl ;
  //
}
//
...
//
void EmuPeripheralCrate::getData0(xgi::Input * in, xgi::Output * out ) 
  throw (xgi::exception::Exception) {
    //
...
//
void EmuPeripheralCrate::CfebDavCableDelay(xgi::Input * in, xgi::Output * out ) 
  throw (xgi::exception::Exception) {
  //
...
//
void EmuPeripheralCrate::TmbLctCableDelay(xgi::Input * in, xgi::Output * out ) 
  throw (xgi::exception::Exception) {
  //
...
//
void EmuPeripheralCrate::PrintDmbValuesAndScopes(xgi::Input * in, xgi::Output * out ) 
  throw (xgi::exception::Exception) {
  //
...
// DMB utilities
///////////////////////////////////////////////////////////
void EmuPeripheralCrate::CFEBStatus(xgi::Input * in, xgi::Output * out ) 
  throw (xgi::exception::Exception) {
  //
  cgicc::Cgicc cgi(in);
  //
...
//
void EmuPeripheralCrate::TMBConfigure(xgi::Input * in, xgi::Output * out ) 
  throw (xgi::exception::Exception) {
  //
  cgicc::Cgicc cgi(in);
  //
...
// CCB utilities
/////////////////////////////////////////////////////////
void EmuPeripheralCrate::CCBStatus(xgi::Input * in, xgi::Output * out ) 
  throw (xgi::exception::Exception) {
  //
  char Name[50] ;
...
//
void EmuPeripheralCrate::MPCStatus(xgi::Input * in, xgi::Output * out ) 
  throw (xgi::exception::Exception) {
  //
  char Name[50] ;
...
//
void EmuPeripheralCrate::MPCUtils(xgi::Input * in, xgi::Output * out ) 
  throw (xgi::exception::Exception) {
  //
  char Name[50] ;
...
// TMB tests methods
//////////////////////////////////////////////////////////////////////////////
void EmuPeripheralCrate::TMBTests(xgi::Input * in, xgi::Output * out ) 
  throw (xgi::exception::Exception) {
  //
  cgicc::Cgicc cgi(in);
  //
...
///////////////////////////////////////////////////////////////////////
void EmuPeripheralCrate::TMBStatus(xgi::Input * in, xgi::Output * out ) 
  throw (xgi::exception::Exception) {
  //
  cgicc::Cgicc cgi(in);
  //
...
////////////////////////////////////////////////////////////////////////////////////
xoap::MessageReference EmuPeripheralCrate::ReadAllVmePromUserid (xoap::MessageReference message) 
  throw (xoap::exception::Exception) {
  //
...
//
xoap::MessageReference EmuPeripheralCrate::LoadAllVmePromUserid (xoap::MessageReference message) 
  throw (xoap::exception::Exception) {
  //
...
//
xoap::MessageReference EmuPeripheralCrate::ReadAllCfebPromUserid (xoap::MessageReference message) 
  throw (xoap::exception::Exception) {
  //
...
//
xoap::MessageReference EmuPeripheralCrate::LoadAllCfebPromUserid (xoap::MessageReference message) 
  throw (xoap::exception::Exception) {
  //
...
//
xoap::MessageReference EmuPeripheralCrate::EnableJtagWriteALCT192 (xoap::MessageReference message) 
  throw (xoap::exception::Exception) {
  //
...
//
xoap::MessageReference EmuPeripheralCrate::EnableJtagWriteALCT288 (xoap::MessageReference message) 
  throw (xoap::exception::Exception) {
  //
...
//
xoap::MessageReference EmuPeripheralCrate::EnableJtagWriteALCT288bn (xoap::MessageReference message) 
  throw (xoap::exception::Exception) {
  //
...
//
xoap::MessageReference EmuPeripheralCrate::EnableJtagWriteALCT288bp (xoap::MessageReference message) 
  throw (xoap::exception::Exception) {
  //
...
//
xoap::MessageReference EmuPeripheralCrate::EnableJtagWriteALCT288fp (xoap::MessageReference message) 
  throw (xoap::exception::Exception) {
  //
...
//
xoap::MessageReference EmuPeripheralCrate::EnableJtagWriteALCT384 (xoap::MessageReference message) 
  throw (xoap::exception::Exception) {
  //
...
//
xoap::MessageReference EmuPeripheralCrate::EnableJtagWriteALCT384Mirror (xoap::MessageReference message) 
  throw (xoap::exception::Exception) {
  //
...
//
xoap::MessageReference EmuPeripheralCrate::EnableJtagWriteALCT576Mirror (xoap::MessageReference message) 
  throw (xoap::exception::Exception) {
  //
...
//
xoap::MessageReference EmuPeripheralCrate::EnableJtagWriteALCT672 (xoap::MessageReference message) 
  throw (xoap::exception::Exception) {
  //
