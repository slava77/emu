// $Id: EmuPeripheralCrateManager.cc,v 1.25 2007/10/25 17:38:31 rakness Exp $
...
{	
  ...
  xgi::bind(this,&EmuPeripheralCrateManager::LoadALCTFirmware, "LoadALCTFirmware");
  //
...
void EmuPeripheralCrateManager::MainPage(xgi::Input * in, xgi::Output * out ) throw (xgi::exception::Exception) {
  ...
  *out << cgicc::fieldset().set("style","font-size: 11pt; font-family: arial;");
  //
  *out << cgicc::legend("TStore in Configuration file").set("style","color:blue") << cgicc::p() << std::endl ;
  //
  ...
  *out << cgicc::fieldset().set("style","font-size: 11pt; font-family: arial;");
  //
  *out << cgicc::legend("JobControl in Configuration file").set("style","color:blue") << cgicc::p() << std::endl ;
  //
  ...
  for ( itDescriptorJobControl = descriptorJobControl.begin(); 
	itDescriptorJobControl != descriptorJobControl.end(); 
	itDescriptorJobControl++ ) {
  ...
  *out << cgicc::fieldset().set("style","font-size: 11pt; font-family: arial;");
  //
  *out << cgicc::legend("LTCControl in Configuration file").set("style","color:blue") << cgicc::p() << std::endl ;
  //
  try {
    ...
    for ( itDescriptorLTCControl = descriptorLTCControl.begin(); 
	  itDescriptorLTCControl != descriptorLTCControl.end(); 
	  itDescriptorLTCControl++ ) {
      //
  ...
  *out << cgicc::form();
  //
  std::string methodSOAPMessageCalibration = toolbox::toString("/%s/SendSOAPMessageCalibrationXRelay",getApplicationDescriptor()->getURN().c_str());
  *out << cgicc::form().set("method","GET").set("action",methodSOAPMessageCalibration) << std::endl ;
  *out << cgicc::input().set("type","submit").set("value","Send SOAP message : Calibration") << std::endl ;
  *out << cgicc::form();
  //
  std::string CheckCalibrationState = toolbox::toString("/%s/CheckEmuPeripheralCrateCalibrationState",getApplicationDescriptor()->getURN().c_str());
  *out << cgicc::form().set("method","GET").set("action",CheckCalibrationState) << std::endl ;
  *out << cgicc::input().set("type","submit").set("value","Check Calibration State") << std::endl ;
  *out << cgicc::form();
  //
  *out << cgicc::fieldset();
  //
  ...
  *out << cgicc::form();
  //
  /*
    std::string methodSOAPMessageOpenFile = toolbox::toString("/%s/SendSOAPMessageOpenFile",getApplicationDescriptor()->getURN().c_str());
    *out << cgicc::form().set("method","GET").set("action",methodSOAPMessageOpenFile) << std::endl ;
    *out << cgicc::input().set("type","submit").set("value","Send SOAP message : Open File") << std::endl ;
    *out << cgicc::form();
    */
  *out << cgicc::fieldset();
  //
  ...
  *out << cgicc::fieldset().set("style","font-size: 11pt; font-family: arial;");
  //
  std::string UploadDB = toolbox::toString("/%s/UpLoadDB",getApplicationDescriptor()->getURN().c_str());
  *out << cgicc::form().set("method","GET").set("action",UploadDB) << std::endl ;
  *out << cgicc::input().set("type","submit").set("value","Upload DB") << std::endl ;
  *out << cgicc::form();
  //
  std::string RetrieveTStoreTable = toolbox::toString("/%s/RetrieveTStoreTable",getApplicationDescriptor()->getURN().c_str());
  *out << cgicc::form().set("method","GET").set("action",RetrieveTStoreTable) << std::endl ;
  *out << cgicc::input().set("type","submit").set("value","Retrieve TStore table") << std::endl ;
  *out << cgicc::form();
  //
  *out << cgicc::fieldset();
  //
  ...
  *out << cgicc::fieldset().set("style","font-size: 11pt; font-family: arial;");
  //
  std::string methodSOAPMessageConnectTStore = toolbox::toString("/%s/SendSOAPMessageConnectTStore",getApplicationDescriptor()->getURN().c_str());
  *out << cgicc::form().set("method","GET").set("action",methodSOAPMessageConnectTStore) << std::endl ;
  *out << cgicc::input().set("type","submit").set("value","Send SOAP message : Connect TStore") << std::endl ;
  *out << cgicc::form();
  //
  std::string methodSOAPMessageDisconnectTStore = toolbox::toString("/%s/SendSOAPMessageDisconnectTStore",getApplicationDescriptor()->getURN().c_str());
  *out << cgicc::form().set("method","GET").set("action",methodSOAPMessageDisconnectTStore) << std::endl ;
  *out << cgicc::input().set("type","submit").set("value","Send SOAP message : Disconnect TStore") << std::endl ;
  *out << cgicc::form();
  //
  std::string methodSOAPMessageQueryTStore = toolbox::toString("/%s/SendSOAPMessageQueryTStore",getApplicationDescriptor()->getURN().c_str());
  *out << cgicc::form().set("method","GET").set("action",methodSOAPMessageQueryTStore) << std::endl ;
  *out << cgicc::input().set("type","submit").set("value","Send SOAP message : Query TStore") << std::endl ;
  *out << cgicc::form();
  //
  std::string methodSOAPMessageDefinitionTStore = toolbox::toString("/%s/SendSOAPMessageDefinitionTStore",getApplicationDescriptor()->getURN().c_str());
  *out << cgicc::form().set("method","GET").set("action",methodSOAPMessageDefinitionTStore) << std::endl ;
  *out << cgicc::input().set("type","submit").set("value","Send SOAP message : Definition TStore") << std::endl ;
  *out << cgicc::form();
  //
  std::string methodSOAPMessageInsertTStore = toolbox::toString("/%s/SendSOAPMessageInsertTStore",getApplicationDescriptor()->getURN().c_str());
  *out << cgicc::form().set("method","GET").set("action",methodSOAPMessageInsertTStore) << std::endl ;
  *out << cgicc::input().set("type","submit").set("value","Send SOAP message : Insert TStore") << std::endl ;
  *out << cgicc::form();
  //
  std::string methodSOAPMessageDeleteTStore = toolbox::toString("/%s/SendSOAPMessageDeleteTStore",getApplicationDescriptor()->getURN().c_str());
  *out << cgicc::form().set("method","GET").set("action",methodSOAPMessageDeleteTStore) << std::endl ;
  *out << cgicc::input().set("type","submit").set("value","Send SOAP message : Delete TStore") << std::endl ;
  *out << cgicc::form();
  //
  std::string methodSOAPMessageClearTStore = toolbox::toString("/%s/SendSOAPMessageClearTStore",getApplicationDescriptor()->getURN().c_str());
  *out << cgicc::form().set("method","GET").set("action",methodSOAPMessageClearTStore) << std::endl ;
  *out << cgicc::input().set("type","submit").set("value","Send SOAP message : Clear TStore") << std::endl ;
  *out << cgicc::form();
  //
  std::string methodSOAPMessageUpdateTStore = toolbox::toString("/%s/SendSOAPMessageUpdateTStore",getApplicationDescriptor()->getURN().c_str());
  *out << cgicc::form().set("method","GET").set("action",methodSOAPMessageUpdateTStore) << std::endl ;
  *out << cgicc::input().set("type","submit").set("value","Send SOAP message : Update TStore") << std::endl ;
  *out << cgicc::form();
  //
  *out << cgicc::fieldset() ;
  //
  ...
  *out << cgicc::fieldset().set("style","font-size: 11pt; font-family: arial;");
  //
  std::string methodSOAPMessageConfigureLTC = toolbox::toString("/%s/SendSOAPMessageConfigureLTC",getApplicationDescriptor()->getURN().c_str());
  *out << cgicc::form().set("method","GET").set("action",methodSOAPMessageConfigureLTC) << std::endl ;
  *out << cgicc::input().set("type","submit").set("value","Send SOAP message : Configure LTC") << std::endl ;
  *out << cgicc::form();
  //
  std::string methodSOAPMessageExecuteSequence = toolbox::toString("/%s/SendSOAPMessageExecuteSequence",getApplicationDescriptor()->getURN().c_str());
  *out << cgicc::form().set("method","GET").set("action",methodSOAPMessageExecuteSequence) << std::endl ;
  *out << cgicc::input().set("type","submit").set("value","Send SOAP message : Execute Sequence") << std::endl ;
  *out << cgicc::form();
  //
  std::string methodSOAPMessageQueryLTC = toolbox::toString("/%s/SendSOAPMessageQueryLTC",getApplicationDescriptor()->getURN().c_str());
  *out << cgicc::form().set("method","GET").set("action",methodSOAPMessageQueryLTC) << std::endl ;
  *out << cgicc::input().set("type","submit").set("value","Send SOAP message : Query LTC InfoSpace") << std::endl ;
  *out << cgicc::form();
  //
  *out << cgicc::fieldset() ;
  //  
  ...
  *out << cgicc::fieldset().set("style","font-size: 11pt; font-family: arial;");
  //
  std::string methodSOAPMessageJobControlStartAllEmuperipheralCrate = toolbox::toString("/%s/SendSOAPMessageJobControlStartAllEmuperipheralCrate",getApplicationDescriptor()->getURN().c_str());
  *out << cgicc::form().set("method","GET").set("action",methodSOAPMessageJobControlStartAllEmuperipheralCrate) << std::endl ;
  *out << cgicc::input().set("type","submit").set("value","Send SOAP message : JobControl Start All EmuPeripheralCrate") << std::endl ;
  *out << cgicc::form();
  /*
    std::string methodSOAPMessageJobControlStartAllProc = toolbox::toString("/%s/SendSOAPMessageJobControlStartAll",getApplicationDescriptor()->getURN().c_str());
    *out << cgicc::form().set("method","GET").set("action",methodSOAPMessageJobControlStartAll) << std::endl ;
    *out << cgicc::input().set("type","submit").set("value","Send SOAP message : JobControl Start All proc for EmuPeripheralCrate") << std::endl ;
    *out << cgicc::form();
    */
  //
  std::string methodSOAPMessageJobControlkillAll = toolbox::toString("/%s/SendSOAPMessageJobControlkillAll",getApplicationDescriptor()->getURN().c_str());
  *out << cgicc::form().set("method","GET").set("action",methodSOAPMessageJobControlkillAll) << std::endl ;
  *out << cgicc::input().set("type","submit").set("value","Send SOAP message : JobControl kill All proc") << std::endl ;
  *out << cgicc::form();
  //
  *out << cgicc::fieldset() ;
  //
...
/////////////////////////////////////////////////////////////////////////////////
void EmuPeripheralCrateManager::DefineBroadcastCrate() {
  //
...
//
void EmuPeripheralCrateManager::LoadALCTFirmware(xgi::Input * in, xgi::Output * out ) {
  //
