...
#endif
  strcpy(((LV_1_DimBroker *)LV_1_DimBroker_o->value)->dynatemTcpIp,ip_address.c_str());
  ((LV_1_DimBroker *)LV_1_DimBroker_o->value)->setNumber=dmb_slot;

  strcpy(((TEMPERATURE_1_DimBroker *)TEMPERATURE_1_DimBroker_o->value)->dynatemTcpIp,ip_address.c_str());
  ((TEMPERATURE_1_DimBroker *)TEMPERATURE_1_DimBroker_o->value)->setNumber=dmb_slot;

  strcpy(((COMMAND_1_DimBroker *)COMMAND_1_DimBroker_o->value)->dynatemTcpIp,ip_address.c_str());
  ((COMMAND_1_DimBroker *)COMMAND_1_DimBroker_o->value)->setNumber=dmb_slot;

  strcpy(((REFERENCE_1_DimBroker *)REFERENCE_1_DimBroker_o->value)->dynatemTcpIp,ip_address.c_str());
  ((REFERENCE_1_DimBroker *)REFERENCE_1_DimBroker_o->value)->setNumber=dmb_slot;
...
// *************************************************************************************************************
    if(operation_command=="get_data_master"){
      ...
      TEMPERATURE_1_DimBroker_o->DcsUpdateService();
...
// *************************************************************************************************************
     ...
     EmuDcs_o->lv_on_wrap(SIMULATION);
#ifdef DCS_PRINTING_1
      printf("on on \n");
#endif
      //////    CONFIRMATION=true;
...
// *************************************************************************************************************
      ...
      if(!SIMULATION){
       ...
       REFERENCE_1_DimBroker_o->DcsUpdateService(); 
   }
...
// *************************************************************************************************************
      ...
      COMMAND_1_DimBroker_o->DcsUpdateService(); 
   }
// *************************************************************************************************************
...
// *************************************************************************************************************
      ...
      if(!SIMULATION){
#ifdef DCS_PRINTING_1
	printf("CRATE CONFIGURATION(BOARDS PROGRAMMING)\n");
#endif
       EmuDcs_o->programAll2004();
#ifdef DCS_PRINTING_1
	printf("CRATE CONFIGURATION(BOARDS PROGRAMMING) DONE\n");
#endif
      }
      else{
#ifdef DCS_PRINTING_1
...
int DcsDimCommand::getDataLV(){
  ...
  ////      printf("get_data!!!!!============================== %d\n", EmuDcs_o->current_set);
	  ...
	  if(EmuDcs_o->lowv_status(SIMULATION))((LV_1_DimBroker *)LV_1_DimBroker_o->value)->data.Alct_o.status=1;
          else ((LV_1_DimBroker *)LV_1_DimBroker_o->value)->data.Alct_o.status=0;
	  ////////  osu_end();
	  ////}
	 /////   else{
    ...
    if(!SUSPEND_UPDATE_SERVICE){
      LV_1_DimBroker_o->DcsUpdateService();
    }
    return 1;
