...
void uploadConfiguration(const std::string &connectionID) throw (xcept::Exception);
void uploadCrates(const std::string &connectionID,xdata::UnsignedInteger64 &key,xdata::String &endcapSide) throw (xcept::Exception);
...
void queryMaxId(const std::string &connectionID, const std::string &tableName, const std::string &dbColumn, xdata::UnsignedInteger64 &result) throw (xcept::Exception);
...
xdata::UnsignedInteger64 addNewSystem(const std::string &connectionID,xdata::UnsignedInteger64 &configID,xdata::String &endcapSide,const std::string &hostname) throw (xcept::Exception);
void readFibers(const std::string &connectionID,const std::string &parentIdentifier,xdata::UnsignedInteger64 &key,xdata::UnsignedShort &rui) throw (xcept::Exception);
