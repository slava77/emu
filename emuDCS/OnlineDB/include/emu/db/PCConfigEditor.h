#ifndef _PCConfigEditor_h_
#define _PCConfigEditor_h_
...
class PCConfigEditor: public ConfigEditor
{
...
public:
  ...
  PCConfigEditor(xdaq::ApplicationStub * s) throw (xdaq::exception::Exception);
  //
   ...
   * implementation of virtual function from ConfigEditor */
  void getDbUserData();
  ...
  void uploadPeripheralCrate(const std::string &connectionID, const std::vector<emu::pc::Crate *> &TStore_allCrates) throw (xcept::Exception);
  ...
  void uploadCSC(const std::string &connectionID, xdata::UnsignedInteger64 &periph_config_id,
                 const std::vector<emu::pc::Chamber *> &TStore_allChambers, int crateID) throw (xcept::Exception);
  void uploadDAQMB(const std::string &connectionID, xdata::UnsignedInteger64 &csc_config_id,
                   emu::pc::DAQMB * &TStore_thisDAQMB, int slot, const std::string &chamber) throw (xcept::Exception);
  void uploadTMB(const std::string &connectionID, xdata::UnsignedInteger64 &csc_config_id,
                 emu::pc::TMB * &TStore_thisTMB, int slot, const std::string &chamber) throw (xcept::Exception);
  void uploadALCT(const std::string &connectionID, xdata::UnsignedInteger64 &tmb_config_id,
                  emu::pc::ALCTController * &TStore_thisALCT, const std::string &identifier) throw (xcept::Exception);
  ...
  emu::pc::EmuEndcap * getConfiguredEndcap(const std::string &emu_config_id) throw (xcept::Exception);
  void readConfiguration(const std::string &connectionID, const std::string &emu_config_id, emu::pc::EmuEndcap * endcap) throw (xcept::Exception);
  void diffCrate(const std::string &connectionID, const std::string &old_emu_config_id, const std::string &new_emu_config_id) throw (xcept::Exception);
  void readPeripheralCrate(const std::string &connectionID, const std::string &emu_config_id, emu::pc::EmuEndcap * endcap) throw (xcept::Exception);
  ...
  void simpleCrateDiff(const std::string &queryViewName, const std::string &connectionID,
                       ...
                       const std::string &new_emu_config_id, const std::string &new_periph_config_id, int crateID) throw (xcept::Exception);
  ...
  void readVCC(const std::string &connectionID, const std::string &emu_config_id, const std::string &periph_config_id,
               emu::pc::Crate * theCrate) throw (xcept::Exception);
  ...
  void readDAQMB(const std::string &connectionID, const std::string &emu_config_id, const std::string &csc_config_id,
                 emu::pc::Crate * theCrate, emu::pc::Chamber * theChamber) throw (xcept::Exception);
  ...
  void readCFEB(const std::string &connectionID, const std::string &emu_config_id, const std::string &daqmb_config_id,
                emu::pc::DAQMB * theDaqmb, const std::string &cacheIdentifier) throw (xcept::Exception);
  ...
  void readALCT(const std::string &connectionID, const std::string &emu_config_id, const std::string &tmb_config_id,
                emu::pc::TMB * theTmb, const std::string &identifier) throw (xcept::Exception);
  ...
  void readAnodeChannel(const std::string &connectionID, const std::string &emu_config_id, const std::string &alct_config_id,
                        emu::pc::ALCTController * theAlct, const std::string &identifier) throw (xcept::Exception);
...
private:
  ...
  std::string getEndcapSide(std::vector<emu::pc::Crate *> &myCrates) throw (xcept::Exception);
  ...
  using ConfigEditor::setCachedDiff;//(const std::string &insertViewName,const std::string &identifier,xdata::Table &table) throw (xcept::Exception);
  using ConfigEditor::setCachedTable;//(const std::string &insertViewName,const std::string &identifier,xdata::Table &table) throw (xcept::Exception);
  ...
  void copyPeripheralCrateToTable(xdata::Table &newRows, emu::pc::Crate * TStore_thisCrate);
  void copyAnodeChannelToTable(xdata::Table &newRows, emu::pc::ALCTController * &TStore_thisALCT);
  void copyALCTToTable(xdata::Table &newRows, emu::pc::ALCTController * &TStore_thisALCT);
  void copyTMBToTable(xdata::Table &newRows, emu::pc::TMB * TStore_thisTMB);
  void copyCFEBToTable(xdata::Table &newRows, emu::pc::DAQMB * TStore_thisDAQMB);
  void copyDAQMBToTable(xdata::Table &newRows, emu::pc::DAQMB * TStore_thisDAQMB);
  void copyCSCToTable(xdata::Table &newRows, emu::pc::Chamber * chamber);
  void copyMPCToTable(xdata::Table &newRows, emu::pc::Crate * TStore_thisCrate);
  void copyCCBToTable(xdata::Table &newRows, emu::pc::Crate * TStore_thisCrate);
  void copyVMECCToTable(xdata::Table &newRows, emu::pc::Crate * TStore_thisCrate);
  ...
  emu::pc::EmuEndcap * TStore_myEndcap_;
  std::map<std::string, xdata::Table> currentTestSummary;
  std::map<std::string, signed int> TTCrxIDs;

  xdata::String tstoreConf_;


  void my_test();
  void readConfigFromDB_test(const std::string &emu_config_id) throw (xgi::exception::Exception);
  void exportAsXML_test(emu::pc::EmuEndcap * endcap, const std::string &filename) throw (xgi::exception::Exception);
  void parseConfigFromEndcap_test(emu::pc::EmuEndcap * endcap) throw (xgi::exception::Exception);
};
