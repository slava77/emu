/*****************************************************************************\
* $Id: TStoreRequest.cc,v 1.1 2010/05/22 21:17:39 liu Exp $
\*****************************************************************************/
...
emu::db::TStoreRequest::TStoreRequest(const std::string &commandName, const std::string &viewClass): 
...
void emu::db::TStoreRequest::addTStoreParameter(const std::string &parameterName, const std::string &parameterValue)
{
...
void emu::db::TStoreRequest::addViewSpecificParameter(const std::string &parameterName, const std::string &parameterValue)
...
void emu::db::TStoreRequest::addParametersWithNamespace(xoap::SOAPElement &element, xoap::SOAPEnvelope &envelope, const std::map<const std::string,std::string> &parameters, const std::string &namespaceURI, const std::string &namespacePrefix)
{
...
xoap::MessageReference emu::db::TStoreRequest::toSOAP()
{
