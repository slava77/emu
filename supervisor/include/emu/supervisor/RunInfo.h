...
emu::supervisor::RunInfo* RunInfo::instance_ = 0; ///< initial pointer

const string RunInfo::runNumKeyword_   ("RUN_NUMBER"         );
const string RunInfo::seqNameKeyword_  ("SEQUENCE_NAME"      );
const string RunInfo::runSeqNumKeyword_("RUN_SEQUENCE_NUMBER");
const string RunInfo::bookingSuccessKeyword_("Created Run Sequence Number");
const string RunInfo::updateSuccessKeyword_ ("Updated parameter"          );
