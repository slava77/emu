...
#define KEY_FILE "/tmp/daq_ipc_cscsx5"         /* Directory to use in ftok calls */
...
#define MSG_QUEUE_ID_OFFSET_TM (char)(NRUN*10) /*my ins -- for test_manager */
...
#define MAX_UPDATES_UNTIL_TIMEOUT             4000
...
int mysem_v();
 ...
 void my_msg_send(char *m, int tyte);
