// $Id: version.h,v 1.4 2010/02/11 22:02:16 banicz Exp $
...
#define PTHTTP_VERSION_MAJOR 1
#define PTHTTP_VERSION_MINOR 0
#define PTHTTP_VERSION_PATCH 0
// If any previous versions available E.g. #define PTHTTP_PREVIOUS_VERSIONS "3.8.0,3.8.1"
#define PTHTTP_PREVIOUS_VERSIONS ""
...
namespace emupthttp
{
    ...
    const std::string description = "Based on daq/pt/http v3.10.13";
