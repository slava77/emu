...
pt::http::PeerTransportSender::PeerTransportSender(Logger & logger, xdata::UnsignedLong* httpResponseTimeoutSec): logger_(logger), httpResponseTimeoutSec_(httpResponseTimeoutSec)
{
